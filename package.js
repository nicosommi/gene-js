...
/* version, /'version': '\bv?(?:0|[1-9][0-9]*)\.(?:0|[1-9][0-9]*)\.(?:0|[1-9][0-9]*)(?:-[\da-z\-]+(?:\.[\da-z\-]+)*)?(?:\+[\da-z\-]+(?:\.[\da-z\-]+)*)?\b'/ig, 'version': '0.0.14' */
...
module.exports =
{
  ...
  'repository': {
    'type': 'git',
    'url': 'git+https://github.com/nicosommi/gene-js.git'
  },
  /* endph */
  /* ph extra */
  /* endph */
  ...
  /* endph */
  /* ph homepage */
  'homepage': 'https://github.com/nicosommi/gene-js'
  /* endph */
}
