...
```
// ES6
import gene-js from "gene-js";
```

```
// ES5
var gene-js = require("gene-js");
```
...
It's easy to run the test suite locally, and *highly recommended* if you're using Gene Js.js on a platform we aren't automatically testing for.
